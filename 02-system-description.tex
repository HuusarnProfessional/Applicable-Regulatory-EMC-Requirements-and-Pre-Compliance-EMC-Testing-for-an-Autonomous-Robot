...
These are simple gate-charge estimates, not the final switch-node rise and fall times
...
case above. The actual \(dV/dt\), \(dI/dt\), and switch-node behaviour therefore also
