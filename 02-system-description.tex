...
\subsection{IMU}
The LSM9DS1 IMU~[\ref{ref:lsm9ds1-datasheet}] is connected to the mainboard through an SPI interface with a ribbon cable that is at maximum 20cm. In the present design, the SPI clock is set by
\begin{equation}
